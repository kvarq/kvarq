...
from kvarq.genes.phylo import PhyloTestsuite, Lineage
...
lineage_bejing   = Lineage('bejing sublineage',lineage2)
...
mainlineages_SNPs = [
    ...
    Test(SNP(genome=ancestor,pos= 749176,base='G'),lineage2,comas09),
...
sublineages_SNPs = [
    ...
    Test(SNP(genome=ancestor,pos=2112832,base='C'),lineage_bejing,stucki12),
    Test(SNP(genome=ancestor,pos=3587446,base='A'),lineage_bejing,stucki12),
    Test(SNP(genome=ancestor,pos=1849051,base='T'),lineage_bejing,stucki12),

    Test(SNP(genome=ancestor,pos=3798451,base='G'),lineage_X,DS),
    Test(SNP(genome=ancestor,pos=2295692,base='T'),lineage_X,DS),
...
more_sublineages_SNPs = [
    ...
    Test(SNP(genome=ancestor,pos=24716,orig='A',base='C'),lineage_13,LR),
    ...
    Test(SNP(genome=ancestor,pos=1788513,orig='C',base='A'),lineage_14,LR),
    ...
    Test(SNP(genome=ancestor,pos=1789795,orig='A',base='G'),lineage_16b,LR),
...
phylo = PhyloTestsuite(mainlineages_SNPs + sublineages_SNPs + more_sublineages_SNPs, VERSION)
