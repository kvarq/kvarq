...
rrsK = DrugResistance('Streptomycin', Gene(ancestor,'rrs', 1471846, 1473382))
...
#    Test(SNP(genome=ancestor, pos=765460, orig='A', base='C'), rpoC, comas12), # is 'C' in ancestor : typo !?
